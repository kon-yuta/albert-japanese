# coding=utf-8
# This file is based on https://github.com/google-research/ALBERT/blob/master/run_classifier.py and https://github.com/yoheikikuta/bert-japanese/blob/master/src/run_classifier.py.
...
class LivedoorProcessor(classifier_utils.DataProcessor):
